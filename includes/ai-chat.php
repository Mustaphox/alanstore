...
<div class="alan-ai-launcher" id="alan-ai-launcher" role="button" aria-label="مستشارة ALAN الذكية" title="مستشارة ALAN الذكية">
    <span class="ai-status-pulse"></span>
    <span class="ai-launcher-tooltip"><?=e($aiName)?> ✨</span>
    
    <!-- Sparkle Icon -->
    <svg class="ai-icon-sparkle" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <!-- Close Icon -->
    <svg class="ai-icon-close" viewBox="0 0 24 24" aria-hidden="true">
        <path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/>
    </svg>
</div>

<!-- AI Chat Modal Widget -->
<div class="alan-ai-widget" id="alan-ai-widget" role="dialog" aria-modal="true" aria-labelledby="ai-dialog-title">
